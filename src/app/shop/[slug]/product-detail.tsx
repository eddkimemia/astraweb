        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <Button size="lg" className="flex-1 h-12 px-8 gap-2 btn-gradient shadow-md" onClick={handleAdd}>
              ...
              <Button
                size="lg"
                variant="outline"
                className={`h-12 px-6 gap-2 ${wishlisted ? "bg-red-50 border-red-300 text-red-500 hover:bg-red-100 hover:text-red-600" : "border-border hover:border-red-500 hover:bg-red-500 hover:text-white"}`}
                onClick={handleWishlist}
              >
                <Heart className={`h-4 w-4 ${wishlisted ? "fill-red-500" : ""}`} />
                {wishlisted ? "Saved" : "Wishlist"}
              </Button>
              <Button size="lg" variant="outline" className="h-12 px-8 gap-2 border-green-500 text-green-600 hover:bg-green-500 hover:text-white" asChild>
